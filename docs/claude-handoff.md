> 기준일: 2026-07-11
> 앱 버전: `0.22`
> 상태: 세법 용어사전(28개, 법적 정의+근거 조문+초딩 설명) 추가 — 가이드 `주요 세법 용어사전` 버튼 + 대시보드 검색(0.22). 다음: 간편장부 Excel import(#5)
...
| 최근 기준 커밋 | `b636bcc feat: eye-level (purpose/intent) guide explanations + legal-basis SSOT skill for app 0.21`. 앱 0.22 변경은 `claude/businesses-crud-rls-validation-v5dzbu` 브랜치 기준 |

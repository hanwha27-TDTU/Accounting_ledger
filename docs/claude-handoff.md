> 기준일: 2026-07-11
> 앱 버전: `0.21`
> 상태: 법령 가이드에 눈높이 설명(목적·취지) 추가 + 법령 기준 SSOT 스킬 신설(0.21). 새 문서 `docs/skills/accounting-legal-basis-reference-skill.md`가 기장의무·경비율·추계·면세 기준의 값·조문·출처·앱 연동 SSOT. 다음: 간편장부 Excel import(#5)
...
| 최근 기준 커밋 | `287a3ad feat: calculator auto-judgement + legal-basis guide topics for app 0.20`. 앱 0.21 변경은 `claude/businesses-crud-rls-validation-v5dzbu` 브랜치 기준 |

> 기준일: 2026-07-11
> 앱 버전: `0.23`
> 상태: 용어 대장 강제 게이트 + 툴팁 단일화(0.23). `TAX_TERMS`↔`docs/accounting-ledger-term-ledger.md` 양방향 일치·필수필드를 `term-ledger-contract`가, 기장의무·경비율 임계값↔legal-basis 문서 정합을 `legal-ssot-contract`가 강제. TERM_HELP 세법 용어 중복 제거, showTerm이 TAX_TERMS 우선. 다음: 간편장부 Excel import(#5). **0.16~0.23 배포 진행 중**
...
| 최근 기준 커밋 | `9888a3b feat: tax-term glossary (legal def + kid explanation) with dashboard search for app 0.22`. 앱 0.23 변경은 `claude/businesses-crud-rls-validation-v5dzbu` 브랜치 기준 |

> 기준일: 2026-07-11
> 앱 버전: `0.17`
> 상태: 입력 자동화 ②그룹 진행 — 경비율(0.15)·기장의무·면세(0.16)에 이어 국세청 간편장부 계정과목 분류표(25개)를 임베드해 가져오기 화면에 표시(0.17). 다음: 간편장부 Excel import(#5) 또는 경비율 초과율 임계표
...
| 최근 기준 커밋 | `b5ca897 feat: bookkeeping-duty & VAT-exemption legal basis display for app 0.16`. 앱 0.17 변경은 `claude/businesses-crud-rls-validation-v5dzbu` 브랜치 기준 |

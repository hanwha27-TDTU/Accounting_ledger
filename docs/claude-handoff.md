> 기준일: 2026-07-11
> 앱 버전: `0.18`
> 상태: 입력 자동화 ②그룹 진행 — 경비율(0.15)·기장의무·면세(0.16)·간편장부 계정과목(0.17)에 이어, 국세청 추계신고(기준경비율) 작성사례의 공식 계산식을 검증 엔진(`EstimatedIncome`, 복식부기 ½·3.4배 / 간편장부 2.8배)으로 구현하고 리포트에 방법·가산세 경고를 안내(0.18). 다음: 간편장부 Excel import(#5)
...
| 최근 기준 커밋 | `5f8c205 feat: NTS simple-bookkeeping account classification table for app 0.17`. 앱 0.18 변경은 `claude/businesses-crud-rls-validation-v5dzbu` 브랜치 기준 |

> 기준일: 2026-07-11
> 앱 버전: `0.30`
> 상태: 해외 거래 통화 선택 목록(0.30). ISO 4217 datalist 자동완성(기축·주요 통화 + UZS 등 28개, 목록 밖 통화도 직접 입력). 그 앞: 해외 구조화 저장(0.29, 마이그레이션 프로덕션 적용). **0.16~0.26 배포됨; 0.27~0.30은 브랜치(마이그레이션은 프로덕션 적용됨)**
...
| 최근 기준 커밋 | `7939069 feat: structured overseas fields on source_transactions (migration) for app 0.29`. 앱 0.30 변경은 `claude/businesses-crud-rls-validation-v5dzbu` 브랜치 기준 |

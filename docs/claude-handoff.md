> 기준일: 2026-07-11
> 앱 버전: `0.28`
> 상태: 거래 입력 해외 거래 연동(0.28). 거래 폼에 `해외 거래` 토글 + 통화·외화·환율 → 원화 자동 환산(입력 보조, 전기 엔진 무변경), 면세사업자 해외 비용 시 대리납부 경고 자동 표시, 내용에 통화·환율 기록. **0.16~0.26 배포됨; 0.27·0.28은 브랜치**
...
| 최근 기준 커밋 | `c9ebc79 feat: overseas purchase/import tax guide + terms for app 0.27`. 앱 0.28 변경은 `claude/businesses-crud-rls-validation-v5dzbu` 브랜치 기준 |

> 기준일: 2026-07-11
> 앱 버전: `0.20`
> 상태: 계산기 고도화 + 법령 가이드(0.20). 추계 계산기에 직전연도 수입 → 기장의무·경비율방법 자동판정 추가. 가이드에 기장의무·부가세 면세·추계 경비율을 근거 조문과 함께 안내하는 버튼 추가. 다음: 간편장부 Excel import(#5)
...
| 최근 기준 커밋 | `9b1ee69 feat: interactive estimated-income calculator UI for app 0.19`. 앱 0.20 변경은 `claude/businesses-crud-rls-validation-v5dzbu` 브랜치 기준 |

...
> 작성 2026-08-02 · 기준 앱 버전 `0.57` · main = 기능 브랜치(`claude/businesses-crud-rls-validation-v5dzbu`) 동일 커밋
...
## 5. 하네스 게이트 14개 — `npm run harness:check` (전부 통과 전엔 완료 선언 금지)
...
| logic-tests | 실제 앱 IIFE를 VM 로드해 188 assertion |
